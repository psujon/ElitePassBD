...
export default function ContactSupport() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 text-left">
      <div className="mb-10 text-center">
        ...
        <h1 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight mt-3 glow-primary">
          Contact Support
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass-card rounded-3xl p-6 border border-slate-800/80 shadow-lg flex flex-col justify-between h-full">
              ...
              <div className="space-y-4 text-xs">
                <div className="flex items-start space-x-3 text-slate-350">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@elitepassbd.com" className="hover:text-violet-400 transition-colors">support@elitepassbd.com</a>
                  </div>
                </div>
            ...
            <div className="border-t border-slate-850/80 pt-6 mt-6 text-center space-y-3">
              <span className="text-xxs font-bold text-slate-500 uppercase block tracking-wider">Fastest Channel</span>
              ...
              <a
                ...
                className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl transition-all shadow-lg shadow-emerald-900/10 flex items-center justify-center space-x-2 active:scale-95 duration-150"
              >
                {/* SVG WhatsApp Icon */}
        ...
        <div className="lg:col-span-2">
          <div className="glass-card rounded-3xl p-6 sm:p-8 border border-slate-800/80 shadow-lg">
            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-6">Send Message</h3>

            {success ? (
              <div className="py-12 text-center space-y-4 animate-fade-in">
                <div className="w-12 h-12 rounded-full bg-emerald-950/40 border border-emerald-900/40 flex items-center justify-center mx-auto text-emerald-400">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-slate-950 hover:bg-slate-850 border border-slate-850 text-slate-400 hover:text-white text-xs font-bold rounded-xl transition-all"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs text-left">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-850 focus:border-violet-500 focus:outline-none rounded-xl px-4 py-2.5 text-xs text-white placeholder-slate-650 transition-all"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="w-full bg-slate-950 border border-slate-850 focus:border-violet-500 focus:outline-none rounded-xl p-4 text-xs text-white placeholder-slate-650 transition-all resize-none"
                  />
                </div>
                ...
                <div className="flex justify-end pt-2">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-6 py-2.5 bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-500 hover:to-pink-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-violet-600/15 disabled:opacity-50 active:scale-95 duration-150 flex items-center space-x-2 glow-button cursor-pointer"
                  >
                    {submitting ? (
                      <>
